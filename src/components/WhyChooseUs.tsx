  ...
  const differentiators = [
    {
      ...
      description: `Serving Anaheim drivers since ${businessConfig.established} with dedicated auto repair and customer care.`,
      icon: "M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285Z",
    },
    {
      title: "Honest Diagnostics & Clear Advice",
      description:
        "We explain what needs immediate attention and what can wait, ensuring you understand your options.",
      icon: "M11.42 15.17 17.25 21A2.652 2.652 0 0 0 21 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655 5.653a2.548 2.548 0 1 1-3.586-3.586l6.837-5.63m5.108-.233c.55-.164 1.163-.188 1.743-.14a4.5 4.5 0 0 0 4.486-6.336l-3.276 3.277a3.004 3.004 0 0 1-2.25-2.25l3.276-3.276a4.5 4.5 0 0 0-6.336 4.486c.091 1.076-.071 2.264-.904 2.95l-.102.085m-1.745 1.437L5.909 7.5H4.5L2.25 3.75l1.5-1.5L7.5 4.5v1.409l4.26 4.26m-1.745 1.437 1.745-1.437m6.615 8.206L15.75 15.75M4.867 19.125h.008v.008h-.008v-.008Z",
    },
    {
      title: "Straightforward Communication",
      description: `Call our shop directly to discuss your vehicle symptoms or requested service. We explain our findings and recommended next steps.`,
              ...
              {differentiators.map((diff, idx) => (
                ...
                >
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <h3 className="text-lg font-bold text-zinc-900">{diff.title}</h3>
                  </div>
