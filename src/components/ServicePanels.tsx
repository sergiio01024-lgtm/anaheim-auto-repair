...
import { cardsData, fullServices } from "../data/services";
...
export function ServicePanels() {
  ...
  return (
    <div
      id="services"
      className="service-card-section bg-gray-50 dark:bg-gray-950/40 border-y border-gray-200 dark:border-white/5 animate-fade-in"
    >
      <ScrollReveal>
        {/* Section header */}
        <div className="service-card-section-header">
          <span className="text-sm font-semibold tracking-wider uppercase text-primary dark:text-red-400 block mb-2">
            Our Services
          </span>
            ...
            return (
              ...
              >
                ...
                <div className="flex items-start justify-between gap-4 mb-2">
                  <span className="text-xs font-bold tracking-widest uppercase text-primary dark:text-red-400 block pt-1">
                    {card.eyebrow}
                  </span>
                  <div className="flex size-10 items-center justify-center rounded-lg bg-red-50 dark:bg-red-950/20 text-primary dark:text-red-400 shrink-0">
        ...
        <div className="mt-12 text-center max-w-xl mx-auto flex flex-col items-center">
          ...
          <div className="flex flex-row gap-3">
            ...
            <a
              href={businessConfig.phone.linkWithCountry}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            {fullServices.map((service, i) => {
              ...
              return (
                ...
                >
                  <div className="flex size-9 items-center justify-center rounded-lg bg-red-50 dark:bg-red-950/20 text-primary dark:text-red-400 shrink-0">
