      ...
      <ScrollReveal>
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
            <div>
              <h2 className="text-base font-semibold text-red-400">About Our Shop</h2>
              ...
              <p className="mt-4 text-lg text-gray-600 dark:text-gray-300">
                Muffler and exhaust work is our specialty, but our team handles everything from brakes and transmissions to engine diagnostics and routine maintenance. Our customers consistently tell us the same thing: we're <strong className="text-white">honest, fast, and we don't upsell you</strong> on work you don't need.
              </p>
              <p className="mt-4 text-lg text-gray-600 dark:text-gray-300">
            ...
            <div className="mt-12 lg:mt-0 flex flex-col gap-4">
              <div className="img-frame ratio-3-2 ring-1 ring-gray-200 dark:ring-white/10 rounded-2xl">
                <div onClick={() => setSelectedPhoto("shop-front")} className="cursor-pointer size-full flex flex-col items-center justify-center bg-zinc-950 p-6 text-center">
              ...
              <div className="img-frame ratio-1-1 ring-1 ring-gray-200 dark:ring-white/10 rounded-2xl">
                <div onClick={() => setSelectedPhoto("shop-team")} className="cursor-pointer size-full flex flex-col items-center justify-center bg-red-950/40 border border-red-900/30 p-6 text-center">
                  <span className="text-gray-400 text-sm font-semibold tracking-wider uppercase mb-2">Photo coming soon</span>
                  <span className="text-gray-500 text-xs max-w-[200px]">Our team at work</span>
                </div>
              </div>
            </div>
          </div>
