  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden border-t border-white/10 bg-gray-900">
      <div className="flex h-16">
        <a href="tel:7148264444" className="flex flex-1 items-center justify-center gap-2 text-white font-semibold text-sm border-r border-white/10 hover:bg-white/5 transition-all duration-200 ease-in-out hover:scale-105 active:scale-95">
          <svg className="size-5 text-red-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
