    ...
    <div id="contact" className="isolate bg-white dark:bg-gray-950 px-6 py-24 sm:py-32 lg:px-8 border-t border-gray-200 dark:border-white/10">
      <ScrollReveal>
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-base font-semibold text-red-650 dark:text-red-400">Get in Touch</h2>
        ...
        {status === "success" ? (
          ...
          <form onSubmit={handleSubmit} className="mx-auto mt-16 max-w-xl sm:mt-20">
            ...
            {status === "error" && <p className="mt-4 text-red-650 dark:text-red-400 text-sm">Something went wrong. Please try again or call us.</p>}
            <div className="mt-10">
