...
export function ContactSection() {
  ...
  // Keep the same ID across failed/retried submissions.
  // Only clear it once the API confirms success.
  ...
  const handleWarningLightChange = (
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.message.trim()) {
      newErrors.message =
        "Please describe the symptoms or problems.";
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Generate once for this logical submission.
    // Failed attempts keep this ID so n8n dedupe remains effective.
    const requestId =
    ...
    try {
      ...
      if (res.ok) {
        // Submission is confirmed. The next new lead gets a new ID.
        requestIdRef.current = null;

        setStatus("success");

        trackEvent({
          type: "estimate_submit_success",
        ...
        // Deliberately do NOT clear requestIdRef here.
        // A retry must reuse the same request_id.
      }
    } catch (err: any) {
      setStatus("error");
      ...
      setErrorMessage(
        "Could not connect to the server. Please call us directly."
      );
      ...
      // Deliberately preserve requestIdRef on network failure.
    }
  };
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="max-w-2xl mb-14 sm:mb-16">
          ...
          <p className="mt-5 text-lg text-[#606770] leading-relaxed">
            Describe your vehicle&apos;s issue and
            we&apos;ll follow up about your service
            request — or call{" "}
            <a
        ...
        >
          ...
          {status === "success" && (
            ...
            >
              ...
              <p className="text-base text-steel-600 leading-relaxed max-w-md mx-auto">
                A shop representative will contact you
                during business hours regarding your
                requested service.
              </p>
          ...
          {status === "error" && (
            <div
              ...
              role="alert"
            >
              <span className="text-signal-red font-bold text-base">
                ⚠ Submission Error
              </span>
            ...
            >
              ...
              {Object.keys(errors).length > 0 && (
                ...
                >
                  <h3
                    ...
                    className="text-sm font-bold text-signal-red"
                  >
              ...
              <div className="pb-8 mb-8 border-b border-[#DDE0E3]">
                <div className="flex items-center gap-3 mb-5">
                  <span className="text-xs font-mono font-bold text-[#C8202F]">
                    01
                  </span>

                  <h3
                    className="text-base font-bold text-[#16191D]"
                    style={{
                      fontFamily:
                        "var(--font-display)",
                    }}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    ...
                    {errors.name && (
                      <p
                        id="name-error"
                        className="mt-1 text-xs text-[#C8202F] font-semibold"
                      >
                        {errors.name}
                      </p>
                    )}
              ...
              <div className="pb-8 mb-8 border-b border-[#DDE0E3]">
                ...
                <div className="mt-5">
                  <span
                    className={`${labelBase} mb-2 block`}
                  >
                  ...
                  <div className="flex flex-wrap gap-3">
                    {[
                      ...
                      <label
                        key={light}
                        className="flex items-center gap-2 text-sm cursor-pointer text-[#606770]"
                      >
                        <input
                          type="checkbox"
                          value={light}
                          checked={formData.warning_lights.includes(
                            light
                          )}
                          onChange={
                            handleWarningLightChange
                          }
              ...
              {getSiteKey() && (
                <div className="pb-8 mb-8 border-b border-[#DDE0E3]">
                  <span
                    className={`${labelBase} mb-3 block`}
                  >
                  ...
                  {errors.turnstile && (
                    <p
                      id="turnstile-error"
                      className="mt-2 text-xs text-[#C8202F] font-semibold"
                    >
                      {errors.turnstile}
                    </p>
                  )}
              ...
              <div>
                ...
                <p className="text-[11px] mt-3 text-center text-[#818891]">
                  ...
                  <a
                    href="/privacy"
                    className="underline hover:text-[#16191D]"
                  >
                    Privacy Policy
                  </a>
                  .
