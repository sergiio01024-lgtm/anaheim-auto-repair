      ...
      <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end lg:gap-x-4 lg:items-center">
          ...
          <a
            ...
            className="text-sm font-semibold transition-colors duration-300 text-gray-700 dark:text-white/70 hover:text-red-600 dark:hover:text-red-400"
          >
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="-m-2.5 rounded-md p-2.5 text-gray-600 dark:text-gray-400 transition-all duration-200 ease-in-out hover:scale-105 active:scale-95"
              >
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-200 dark:divide-white/10">
              ...
              <div className="py-6 flex flex-col gap-3">
                <a
                  href={businessConfig.phone.link}
                  className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold text-gray-900 dark:text-white hover:bg-gray-100 hover:text-red-600 dark:hover:bg-white/5 dark:hover:text-red-400"
                >
